...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{if}\;\neg \;(\Varid{sep}\;\Varid{c})\mathrel{\wedge}\Varid{lookahead\char95 sep}\;(\Varid{id}\;\Varid{l})\;\mathbf{then}\;\Varid{wc\char95 w}\;\Varid{l}\mathbin{+}\mathrm{1}\;\mathbf{else}\;\Varid{wc\char95 w}\;\Varid{l}{}\<[E]%
\\
\>[6]{}\hsindent{2}{}\<[8]%
\>[8]{}\mathbf{where}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseNEList}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{f}+\Varid{g}\times\Varid{f}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{g\char95 list2LTree}\;\Varid{l}\mathrel{=}i_2\;(\Varid{r}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}{}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{r}\mathrel{=}\Varid{splitAt}\;(\length \;\Varid{l}\div \mathrm{2})\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{g\char95 lTree2MTree}\mathrel{=}\mathsf{in}\comp (\conj{\Varid{\Conid{Main}.hash}}{\Varid{id}}+\conj{\Varid{k}}{\Varid{id}}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{where}\;\Varid{k}\mathrel{=}\Varid{concHash}\comp (\Varid{firsts}\times\Varid{firsts})\comp (\mathsf{out}\times\mathsf{out}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{wrapper}\mathbin{::}(\mathbb{Z},[\mskip1.5mu \Conid{Char}\mskip1.5mu])\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{wrapper}\mathrel{=}\Varid{fromIntegral}\comp \p1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g1}\mathbin{::}\Varid{b}\to (\mathbb{Z},[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
...
\\
\>[B]{}h_2 \;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\mathbf{if}\;\neg \;(\Varid{sep}\;\Varid{a})\mathrel{\wedge}\Varid{lookahead\char95 sep}\;\Varid{c}\;\mathbf{then}\;\succ \;\Varid{b}\;\mathbf{else}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}{}\<[E]%
\\
...
\>[11]{}\Varid{lookahead\char95 sep}\;(\Varid{c}\mathbin{:}\Varid{l})\mathrel{=}\Varid{sep}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}k_1 \mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}k_2 \;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Varid{cons}\;(\Varid{a},\Varid{c}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseX}\;\Varid{f}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{f}+(\Varid{g}{}\<[25]%
\>[25]{}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recX}\;\Varid{f}\mathrel{=}\Varid{baseX}\;\Varid{id}\;\Varid{f}\;\Varid{id}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[13]%
\>[13]{}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{z})\mathrel{=}i_2\;((\Varid{x},\Varid{y}),\Varid{y}\mathbin{:}\Varid{z}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}f_2 \mathrel{=}\uncurry{\uncurry{\Varid{mySub}}}\comp \Varid{sp}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{sp}\mathrel{=}\conj{\uncurry{\Varid{toCell}}}{\p1}\times\Varid{id}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{mySub}\;\Varid{c}\;(\Varid{x},\Varid{y})\;\Varid{g}\;\Varid{m}{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\mid (\Varid{m}\mathbin{!!}\Varid{y})\mathbin{!!}\Varid{x}\equiv \Conid{Blocked}\mathrel{=}\Varid{g}\;\Varid{m}{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\mid \Varid{otherwise}\mathrel{=}\Varid{subst}\;(\Varid{subst}\;\Varid{c}\;\Varid{x}\;(\Varid{g}\;\Varid{m}\mathbin{!!}\Varid{y}))\;\Varid{y}\;(\Varid{g}\;\Varid{m}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
