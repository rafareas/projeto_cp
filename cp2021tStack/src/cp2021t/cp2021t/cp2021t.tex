...
%
        ...
        \ensuremath{\begin{lcbr}\Varid{outExpAr}\comp \underline{\Varid{x}}\mathrel{=}i_1\\\Varid{outExpAr}\comp \Varid{num\char95 ops}\mathrel{=}i_2\end{lcbr}}

%
\just\equiv{Substituição: num_ ops}
%

        \ensuremath{\begin{lcbr}\Varid{outExpAr}\comp \underline{\Varid{x}}\mathrel{=}i_1\\\Varid{outExpAr}\comp [\mskip1.5mu \Conid{N},\Varid{ops}\mskip1.5mu]\mathrel{=}i_2\end{lcbr}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outExpAr}\;\Varid{x}{}\<[13]%
\>[13]{}\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\;(i_1\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}{}\<[25]%
\>[25]{}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b})))){}\<[E]%
\\
