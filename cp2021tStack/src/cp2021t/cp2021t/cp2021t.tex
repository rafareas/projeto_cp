...
&
    \ensuremath{\N_0\mathbin{+}\N_0\;\Conid{X}\;\N_0\mathbin{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\;\Conid{X}\mathbin{<}\Varid{avg},\length \mathbin{>}}}
           \ar[l]_-{\ensuremath{\Varid{id}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\N_0\mathbin{+}(\N_0\;\Conid{X}\;(\N_0\;\Conid{X}\;\N_0))}
           \ar[l]^-{\ensuremath{\alt{\underline{\mathrm{1}}}{\succ \comp \p2\comp \p2}}}
}
\end{eqnarray*}
...
&
     \ensuremath{\N_0\mathbin{+}(\N_0\;\Conid{X}\;(\N_0\;\Conid{X}\;\N_0))}
           \ar[l]^-{\ensuremath{\alt{\Varid{id}}{\Varid{alfa}}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\N_0}
           \ar[d]_-{\ensuremath{\length }}
&
    \ensuremath{\N_0\mathbin{+}(\mathsf{LTree}\;\N_0)\mathbin{**}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\conj{\Varid{avg}}{\length }\mathbin{**}}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\N_0\mathbin{+}((\mathsf{LTree}\;\N_0)\;\Conid{X}\;(\mathsf{LTree}\;\N_0))\mathbin{**}}
...
\just\equiv{ Fokkinga }
%
    \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\llparenthesis\, \conj{\alt{\Conid{Leaf}}{\Varid{alfavg}}}{\alt{\underline{\mathrm{1}}}{\Varid{alflen}}}\,\rrparenthesis} 
%
\just\equiv{ Lei da Troca }
%
    \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\llparenthesis\, \alt{\conj{\Conid{Leaf}}{\underline{\mathrm{1}}}}{\conj{\Varid{alfavg}}{\Varid{alflen}}}\,\rrparenthesis} 
\qed
\end{eqnarray*}
