...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment outExpAr = undefined}{}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;\Varid{x}\mathrel{=}i_1\;\Varid{x}{}\<[20]%
\>[20]{}\mbox{\onelinecomment  tentar  outExpAr x = i1 x }{}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_1\;(i_2\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Conid{Sum}\;\Varid{a}\;\Varid{b})\mathrel{=}{}\<[26]%
\>[26]{}i_2\;(i_2\;(i_1\;(\Conid{Sum},(\Varid{a},\Varid{b})))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a}\;\Varid{b})\mathrel{=}{}\<[30]%
\>[30]{}i_2\;(i_2\;(i_1\;(\Conid{Product},(\Varid{a},\Varid{b})))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Conid{Negate}\;\Varid{a})\mathrel{=}i_2\;(i_2\;(i_2\;(\Conid{Negate},\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Conid{E}\;\Varid{a})\mathrel{=}i_2\;(i_2\;(i_2\;(\Conid{E},\Varid{a}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recExpAr}\;\Varid{x}\mathrel{=}\Varid{baseExpAr'}\;\Varid{id}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{h})\mathrel{=}(((\mathrm{4}\mathbin{*}\Varid{h})\mathbin{+}\mathrm{2})\mathbin{*}\Varid{c}\div \Varid{h}\mathbin{+}\mathrm{2},\Varid{add}\;(\mathrm{1},\Varid{h})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{0}){}\<[E]%
\\
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\N_0\mathbin{*}}
           \ar[d]_-{\ensuremath{\length }}
&
    \ensuremath{\N_0\mathbin{+}\N_0\;\Conid{X}\;\N_0\mathbin{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\;\Conid{X}\lambda \Varid{begin}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}\;\conj{\cdot }{\cdot }\;\Varid{avg}\;\length \lambda \Varid{end}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}}}
           \ar[l]_-{\ensuremath{\lambda \Varid{begin}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}\;\Varid{id}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}\lambda \Varid{end}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\N_0\mathbin{+}(\N_0\lambda \Varid{times}\;(\N_0\lambda \Varid{times}\;\N_0))}
           \ar[l]^-{\ensuremath{\lambda \Varid{begin}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}\;\alt{\cdot }{\cdot }\;\underline{\mathrm{1}}\;(\succ \comp \p2\comp \p2)\lambda \Varid{end}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}}}
}
\end{eqnarray*}
...
&
    \ensuremath{\N_0\mathbin{+}\N_0\lambda \Varid{times}\;\N_0\mathbin{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\lambda \Varid{times}\;\conj{\cdot }{\cdot }\;\Varid{avg}\;\length }}
           \ar[l]_-{\ensuremath{\lambda \Varid{begin}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}\;\Varid{id}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}\lambda \Varid{end}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\N_0\mathbin{+}(\N_0\lambda \Varid{times}\;(\N_0\lambda \Varid{times}\;\N_0))}
           \ar[l]^-{\ensuremath{\lambda \Varid{begin}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}\;\alt{\cdot }{\cdot }\;\Varid{id}\;\Varid{alfa}\lambda \Varid{end}\;\{\mskip1.5mu \Varid{equation}\mskip1.5mu\}}}
}
\end{eqnarray*}
...
\just\equiv{ Fokkinga }
%
    \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\alt{\Varid{id}}{\Varid{alfa}}}{\alt{\underline{\mathrm{1}}}{\succ \comp \p2\comp \p2}}}}     
%
\just\equiv{ Lei da Troca }
%
    \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{alfa}}{\succ \comp \p2\comp \p2}}}}
\qed
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outLSingl}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[18]%
\>[18]{}\mathrel{=}i_1\;(\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{outLSingl}\;(\Varid{a}\mathbin{:}\Varid{x})\mathrel{=}i_2\;(\Varid{a},\Varid{x}){}\<[E]%
\\
\>[B]{}\Varid{cataLSingl}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recList}\;(\Varid{cataLSingl}\;\Varid{g})\comp \Varid{outLSingl}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Definição final:
\begin{hscode}\SaveRestoreHook
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataLSingl}\;\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{alfa}}{\succ \comp \p2\comp \p2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{43}{}\<[43]%
\>[43]{}\Varid{alfa}\;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}((\Varid{a}\mathbin{+}(\Varid{avg}\mathbin{*}\Varid{l}))\mathbin{/}(\Varid{l}\mathbin{+}\mathrm{1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\N_0}
           \ar[d]_-{\ensuremath{\length }}
&
    \ensuremath{\N_0\mathbin{+}((\mathsf{LTree}\;\N_0)\mathbin{\uparrow}\mathrm{2})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\conj{\Varid{avg}}{\length }\mathbin{\uparrow}\mathrm{2})}}
           \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\N_0\mathbin{+}(((\mathsf{LTree}\;\N_0)\;\Conid{X}\;(\mathsf{LTree}\;\N_0))\mathbin{\uparrow}\mathrm{2})}
           \ar[l]^-{\ensuremath{\alt{\underline{\mathrm{1}}}{\Varid{alflen}}}}
}
\end{eqnarray*}
...
&
     \ensuremath{\N_0\mathbin{+}(((\mathsf{LTree}\;\N_0)\;\Conid{X}\;(\mathsf{LTree}\;\N_0))\mathbin{\uparrow}\mathrm{2})}
           \ar[l]^-{\ensuremath{\alt{\Conid{Leaf}}{\Varid{alfavg}}}}
}
\end{eqnarray*}
...
\just\equiv{ Fokkinga }
%
    \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\llparenthesis\, \conj{\alt{\Conid{Leaf}}{\Varid{alfavg}}}{\alt{\underline{\mathrm{1}}}{\Varid{alflen}}}\,\rrparenthesis\lambda ;\mathbf{where}\lambda ;\Varid{alfavg}\;(\Varid{avg},\Varid{len})\mathrel{=}\Varid{avg}\mathbin{/}\Varid{len}\;\Varid{alflen}\;((e_1 ,\Varid{d1}),(e_2 ,\Varid{d2}))\mathrel{=}e_2 \mathbin{+}\Varid{d2}}     
%
\just\equiv{ Lei da Troca }
%
    \ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\llparenthesis\, \alt{\conj{\Conid{Leaf}}{\underline{\mathrm{1}}}}{\conj{\Varid{alfavg}}{\Varid{alflen}}}\,\rrparenthesis}\;where\;
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\bot \mbox{\onelinecomment either((split (Leaf) (const 1)) (split (alfavg) (alflen))) where}{}\<[E]%
\\
\>[4]{}\hsindent{7}{}\<[11]%
\>[11]{}\mbox{\onelinecomment   alfavg(avg,len) = div(avg len)}{}\<[E]%
\\
\>[4]{}\hsindent{7}{}\<[11]%
\>[11]{}\mbox{\onelinecomment   alflen((e1,d1),(e2,d2)) = add(e2,d2)}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
