...
\\
\>[B]{}\mbox{\onelinecomment outExpAr x = i1 x  -- tentar  outExpAr x = i1 x }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment outExpAr(N x) = i1(i2 x) }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment outExpAr(Bin op a b) =  i2(i2(i1(op,(a,b))))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment outExpAr (Un op a) = i2(i2(i2(op,a)))}{}\<[E]%
\\[\blanklineskip]%
